  ...
  return (
    ...
    >
      ...
      >
        {page.label}
        <i
          className="fas fa-chevron-down nav-caret"
...
export default function Navbar() {
  ...
  const isActive = (page) =>
    page.to
      ...
      : location.pathname.startsWith(page.base);
      ...
      <div className={`mobile-menu${mobileOpen ? " open" : ""}`}>
        {[
          ...pages,
          {
            base: "/contact",
            label: "Contact",
            sub: [{ tab: "formulaire", label: "Formulaire" }],
          },
        ].map((p) => (
          <div key={p.to || p.base} className="mobile-nav-item">
            <div className="mobile-nav-row">
              ...
              {p.sub && p.sub.length > 1 && (
                ...
                >
                  <i
                    className={`fas fa-chevron-${mobileExpanded === (p.to || p.base) ? "up" : "down"}`}
                  />
                </button>
              )}
            </div>
